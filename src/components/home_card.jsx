function HomeCard(props) {
    return(
        <div className="hiddens cards bg-[#323232] rounded-[12px] border border-[#515151] flex flex-col justify-center items-center gap-4 w-100 h-100" style={{padding: "15px"}}>
